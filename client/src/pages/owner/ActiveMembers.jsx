...
//                 <button onClick={fetchData} className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm">
//                     Retry
//                 </button>
//             </div>
//         </div>
...
//                 <h1 className="text-xl font-bold text-gray-900 mb-5">Active Members</h1>

//                 <SectionActive data={active} onUpgrade={handleUpgrade} />
...
// const SectionActive = ({ data, onUpgrade }) => {
...
//                     <span className="ml-1 px-2 py-0.5 rounded-full text-xs font-bold text-white bg-green-500">{data.length}</span>
//                 </div>
...
//             {!collapsed && (
//                 data.length === 0 ? (
//                     <div className="py-10 text-center text-gray-400 text-sm">No active members</div>
//                 ) : (
//                     <div className="overflow-x-auto">
//                         <table className="w-full text-sm">
//                             <thead>
//                                 <tr className="border-b border-gray-100">
//                                     {["#", "Member", "Expiry", "Days Left", "Last Payment", "Type", "Actions"].map(h => (
...
//                                     // const lastPayment = m.lastPaymentDate ? new Date(m.lastPaymentDate).toLocaleDateString("en-IN") : "—";

//                                     return (
//                                         <tr key={m._id} className="hover:bg-gray-50">
//                                             <td className="px-5 py-3 text-gray-400 text-xs">{i + 1}</td>
//                                             <td className="px-5 py-3">{m.name}</td>
//                                             <td className="px-5 py-3">{expiry.toLocaleDateString("en-IN")}</td>
//                                             <td className="px-5 py-3">
//                                                 <span className="text-xs font-bold px-2.5 py-1 rounded-full" style={{ background: dayColor + "22", color: dayColor }}>
//                                                     {daysLeft}d left
//                                                 </span>
//                                             </td>
//                                             <td className="px-5 py-3 text-gray-500 whitespace-nowrap">
//                                                 {m.lastPlanDate
//                                                     ? new Date(m.lastPlanDate).toLocaleDateString("en-IN", {
//                                                         day: "2-digit",
//                                                         month: "short",
//                                                         year: "numeric"
//                                                     })
...
//                                             </td>
//                                             <td className="px-5 py-3">
//                                                 <button onClick={() => onUpgrade(m._id)} className="px-3 py-1.5 text-xs text-white rounded-lg bg-purple-700">Upgrade</button>
//                                             </td>
//                                         </tr>
//                                     );
//                                 })}
