...
//         if (!form.fitnessplan || !form.duration || !form.price) {
...
//             await API.post("/owner/plan/create", form, {
//                 headers: { Authorization: `Bearer ${token}` },
//             });

//             // Reset form
//             setForm({ plan: "", fitnessplan: "", duration: "", price: "" });

//             // Navigate back to PlanPage
...
//                 <div className="mb-6">
//                     <h1 className="text-2xl font-semibold text-gray-800">Add Plan</h1>
//                     <p className="text-sm text-gray-500 mt-1">Create a new gym membership plan</p>
//                 </div>
...
//                             <select name="fitnessplan" value={form.fitnessplan} onChange={handleChange} required
...
//                                 <option>General Fitness Plan</option>
//                                 <option>Fat Burn Plan</option>
//                                 <option>Strength Plan</option>
//                             </select>
//                         </div>

//                         <div className="flex flex-col gap-1">
//                             <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Duration (Months)</label>
//                             <input type="number" name="duration" placeholder="e.g. 3" value={form.duration} onChange={handleChange} required
...
//                             <input type="number" name="price" placeholder="e.g. 999" value={form.price} onChange={handleChange} required
//                                 className="px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
//                         </div>
