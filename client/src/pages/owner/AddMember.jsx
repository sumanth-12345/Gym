...
//         if (!formData.name || !formData.phone || !formData.password || !formData.joinDate) {
...
//                 <div className="mb-6">
//                     <h1 className="text-2xl font-semibold text-gray-800">Add Member</h1>
//                     <p className="text-sm text-gray-500 mt-1">Fill in the details to register a new member</p>
//                 </div>
...
//                         <div className="flex flex-col gap-1">
//                             <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Trainer Required</label>
...
//                             <input name="healthIssues" value={formData.healthIssues} onChange={handleChange}
//                                 className="px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
//                         </div>

//                         <div className="flex flex-col gap-1">
//                             <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Plan (Months)</label>
