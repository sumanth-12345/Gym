...
//                 const mem = await API.get("/owner/reports/members", {
//                     headers: { Authorization: `Bearer ${token}` },
//                 });
...
//                     <p className="text-sm text-gray-500 mt-1">Overview of members and revenue</p>
//                 </div>
...
//                         {[
//                             { label: "Total Members", value: members.totalMembers, color: "text-gray-800" },
//                             { label: "New Today", value: members.newMembers, color: "text-blue-600" },
//                             { label: "Expired", value: members.expiredMembers, color: "text-red-500" },
//                         ].map((c) => (
...
//                                 {["Month", "Total", "Completed", "Pending"].map((h) => (
...
//                                     <td className="px-5 py-3.5 text-sm font-medium text-gray-800">{r._id.month}/{r._id.year}</td>
//                                     <td className="px-5 py-3.5 text-sm font-semibold text-gray-800">₹{r.totalAmount}</td>
//                                     <td className="px-5 py-3.5">
//                                         <span className="inline-flex px-2.5 py-1 rounded-full text-xs font-medium bg-green-50 text-green-700">{r.completed}</span>
//                                     </td>
//                                     <td className="px-5 py-3.5">
//                                         <span className="inline-flex px-2.5 py-1 rounded-full text-xs font-medium bg-yellow-50 text-yellow-700">{r.pending}</span>
//                                     </td>
//                                 </tr>
//                             )) : (
//                                 <tr>
//                                     <td colSpan="4" className="text-center py-12 text-sm text-gray-400">No revenue data</td>
//                                 </tr>
//                             )}
//                         </tbody>
//                     </table>
